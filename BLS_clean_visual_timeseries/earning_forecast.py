...
dataset = pd.read_csv("allDatasets/dataset_53.csv")
name = 'education_and_health_services_avgweeklyEarning'
...
yearly_earning_forcast = np.mean(future_forecast)*52
print (future_forecast, yearly_earning_forcast)
...
temp_future = [
    ...
    ['2020-01-01', yearly_earning_forcast]
]
...
output_path = 'results/earnings_forecasts/tables'
#result.to_csv
